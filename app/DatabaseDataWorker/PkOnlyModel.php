...
abstract class PkOnlyModel extends Core implements IModel
{
  ...
  static public function InitVault()
  {
    !isset(self::$Vault)
  ...
  static public function Get($key_v = null, $returned = null): ?PkOnlyModel
  {
  ...
  static public function Create(): PkOnlyModel
  {
